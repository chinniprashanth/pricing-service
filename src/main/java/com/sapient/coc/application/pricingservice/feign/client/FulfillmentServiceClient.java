...
@FeignClient(name = "fulfillment-service", url = "${application.fulfillment.client.url}", fallback = FulfillmentServiceFalBack.class, configuration = FeignConfigurationPricing.class)
