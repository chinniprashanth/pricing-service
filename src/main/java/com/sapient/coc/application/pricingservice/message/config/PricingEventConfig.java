...
public class PricingEventConfig {
	/*
	 * @Value(value = "${spring.kafka.groupId}") private String groupId;
	 * 
	 ...
	 *//**
		 ...
		 */
	/*
	 * @Bean public ConsumerFactory<String, CartResponse> getconsumerFactory() {
	 ...
	 *//**
		 ...
		 */
	/*
	 * @Bean public ConcurrentKafkaListenerContainerFactory<String, CartResponse>
	 * pricingConsumerFactory() { ConcurrentKafkaListenerContainerFactory<String,
	 * CartResponse> factory = new ConcurrentKafkaListenerContainerFactory<>();
